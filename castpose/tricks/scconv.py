...
class GroupBatchnorm2d(nn.Module):
    def __init__(self, c_num:int, group_num:int = 16, eps:float = 1e-10):
        ...
        self.eps        = eps  # 设置小的常数 eps 用于稳定计算,使得反串不会为0，防止梯度消失
...
class SRU(nn.Module):
    ...
    def forward(self, x):
        ...
        w_gamma     = w_gamma.view(1,-1,1,1)##维度变化
        ...
        x_1          = info_mask * gn_x  # 使用信息门控掩码
        x_2          = noninfo_mask * gn_x  # 使用非信息门控掩码
